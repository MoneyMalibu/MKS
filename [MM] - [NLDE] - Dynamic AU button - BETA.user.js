            ...
            for (var c in GameMissieData[i].requirements) {
                ...
                if (c === 'water_needed') {
                    ...
                    for (var wv = 0; wv < VoertuigenWaterVersterking.length; wv++) {
                        let tmpVoertuigProcent = VoertuigenWaterVersterking[wv][1];
                        let tmpVoertuigenAanwezig = VoertuigenDefinitie[VoertuigenWaterVersterking[wv][0]][3];
...
function LoadVoertuigen() {
    ...
    VoertuigenDefinitie[23][1] = 'NIKS'; //Voertuig naam
    ...
    VoertuigenDefinitie[38][2] = ''; //Mission Regel gekoppeld bijvoorbeeld: "firetrucks"
